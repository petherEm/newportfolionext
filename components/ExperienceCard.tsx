...
const ExperienceCard = ({ experience }: Props) => {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-2 h-[550px] flex-shrink-0 w-[400px] md:w-[600px] xl:w-[900px] snap-center p-4 md:p-10 bg-[#201f1f] hover:opacity-100 opacity-70 cursor-pointer transition-opacity duration-200 overflow-hidden">
      <div className="px-0 md:px-10">
        ...
        >
          <img
            className="w-20 h-20 rounded-full md:rounded-full  object-center"
